...
(function() {
  ...
  CaliperResponseError = (function(superClass) {
    extend(CaliperResponseError, superClass);

    function CaliperResponseError(message) {
      this.message = message;
      CaliperResponseError.__super__.constructor.apply(this, arguments);
    }

    return CaliperResponseError;
  ...
  module.exports = {
    ...
    CaliperResponseError: CaliperResponseError
  };
