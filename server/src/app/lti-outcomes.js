...
import xml_builder from 'xmlbuilder';
import errors from '../errors';
import HMAC_SHA1 from '../hmac-sha1';
...
export default class OutcomeDocument {
...
class OutcomeService {
  ...
  constructor(options) {
    ...
    this.REQUEST_REPLACE = 'replaceResult';
    this.REQUEST_READ = 'readResult';
    this.REQUEST_DELETE = 'deleteResult';
...
defaultExport.init = function (provider) {
