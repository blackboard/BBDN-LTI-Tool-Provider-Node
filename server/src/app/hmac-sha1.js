...
(function () {
  var HMAC_SHA1, HMAC_SHA2, _clean_request_body, crypto, exports, url, utils;
...
//      console.log("SHA1 string: " + str);
  ...
  HMAC_SHA2 = (function () {
    ...
    HMAC_SHA2.prototype.build_signature_raw = function (req_url, parsed_url, method, params, consumer_secret, token) {
      var sig;
      sig = [method.toUpperCase(), utils.special_encode(req_url), _clean_request_body(params, parsed_url.query)];
      return this.sign_string(sig.join('&'), consumer_secret, token);
    };

    HMAC_SHA2.prototype.build_signature = function () {
      var encrypted, hapiRawReq, hitUrl, originalUrl, parsedUrl, protocol;
      hapiRawReq = req.raw && req.raw.req;
      if (hapiRawReq) {
        req = hapiRawReq;
